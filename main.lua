...
return function(Title, Parent)
    ...
    [15] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(15)local Root = script.Parent.Parent
local Flipper = require(Root.Packages.Flipper)
local Creator = require(Root.Creator)
...
function TabModule:New(Title, Icon, Parent)
	...
	-- Override element creation to track elements for search
	local originalMeta = getmetatable(Tab)
	local wrappedMeta = {}
	setmetatable(wrappedMeta, { __index = originalMeta })
	
	wrappedMeta.__index = function(self, key)
		local originalFunc = originalMeta[key]
		if type(originalFunc) == "function" and key:match("^Add") then
			return function(selfArg, idx, config)
				local result = originalFunc(selfArg, idx, config)
				-- Register element for search
				if result and type(config) == "table" then
					local elementData = {
						Type = "Element",
						Name = config.Title or idx or "",
						Title = config.Title or idx or "",
						Description = config.Description or "",
						TabName = Title,
						TabIndex = TabIndex,
						Frame = result.Frame,
						ElementType = key:sub(4), -- Remove "Add" prefix
					}
					table.insert(Library.AllElements, elementData)
...
return TabModule
    ...
    [16] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(16)local TextService = game:GetService("TextService")
local Root = script.Parent.Parent
local Flipper = require(Root.Packages.Flipper)
local Creator = require(Root.Creator)
local New = Creator.New
...
return function(Config)
	...
	-- Search Box holder (positioned on far LEFT)
	...
	-- Title and Subtitle holder (CENTERED with max width constraint)
	local TitleHolder = New("Frame", {
		...
		New("UISizeConstraint", {
			MaxSize = Vector2.new(280, math.huge), -- Limit max width to prevent overlap
		}),
		New("UIListLayout", {
		...
		New("TextLabel", {
			...
			New("UISizeConstraint", {
				MaxSize = Vector2.new(180, math.huge), -- Limit title width
			}),
		}),
		New("TextLabel", {
			RichText = true,
			...
			New("UISizeConstraint", {
				MaxSize = Vector2.new(80, math.huge), -- Limit subtitle width
			}),
		}),
		}),
	})
	...
	TitleBar.Search = SearchModule(SearchHolder, Config.Window, function(result)
		-- Handle search result click
		if result.Type == "Tab" and result.TabIndex then
			-- Select the tab
			if Config.Window and Config.Window.SelectTab then
				Config.Window:SelectTab(result.TabIndex)
			end
		elseif result.Frame then
			-- Scroll to element and highlight it
			if result.TabIndex then
			...
			task.spawn(function()
				if result.Frame and result.Frame:IsA("GuiObject") then
					local originalTransparency = result.Frame.BackgroundTransparency
					for i = 1, 3 do
						result.Frame.BackgroundTransparency = 0.5
						task.wait(0.15)
						result.Frame.BackgroundTransparency = originalTransparency
						task.wait(0.15)
					end
				end
			end)
    ...
    [18] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(18)-- i will rewrite this someday
local UserInputService = game:GetService("UserInputService")
local Mouse = game:GetService("Players").LocalPlayer:GetMouse()
local Camera = game:GetService("Workspace").CurrentCamera
...
return Element
    ...
    [29] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(29)-- This file was @generated by Tarmac. It is not intended for manual editing.
return {
	assets = {
    ...
    [31] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(31)local Flipper = {
...
return Flipper
    ...
    [32] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(32)local RunService = game:GetService("RunService")
...
return BaseMotor
    ...
    [33] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(33)return function()
	local RunService = game:GetService("RunService")
    ...
    [34] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(34)local BaseMotor = require(script.Parent.BaseMotor)
...
return GroupMotor
    ...
    [35] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(35)return function()
    ...
    [36] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(36)local Instant = {}
...
return Instant
    ...
    [37] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(37)return function()
	local Instant = require(script.Parent.Instant)
    ...
    [38] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(38)local Linear = {}
...
return Linear
    ...
    [39] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(39)return function()
	local SingleMotor = require(script.Parent.SingleMotor)
    ...
    [40] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(40)local Connection = {}
...
return Signal
    ...
    [41] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(41)return function()
	local Signal = require(script.Parent.Signal)
    ...
    [42] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(42)local BaseMotor = require(script.Parent.BaseMotor)
...
return SingleMotor
    ...
    [43] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(43)return function()
	local SingleMotor = require(script.Parent.SingleMotor)
	local Instant = require(script.Parent.Instant)
    ...
    [44] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(44)local VELOCITY_THRESHOLD = 0.001
...
return Spring
    ...
    [45] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(45)return function()
	local SingleMotor = require(script.Parent.SingleMotor)
	local Spring = require(script.Parent.Spring)
    ...
    [46] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(46)local function isMotor(value)
...
return isMotor
    ...
    [47] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(47)return function()
	local isMotor = require(script.Parent.isMotor)
    ...
    [48] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(48)local Themes = {
	Names = {
		"Dark",
		"Darker",
		"Light",
...
return Themes
	...
	Name = "Dark",
	Accent = Color3.fromRGB(88, 166, 255), -- Modern blue accent

	AcrylicMain = Color3.fromRGB(32, 32, 36),
	AcrylicBorder = Color3.fromRGB(60, 60, 65),
	AcrylicGradient = ColorSequence.new(Color3.fromRGB(28, 28, 32), Color3.fromRGB(22, 22, 26)),
	AcrylicNoise = 0.92,

	TitleBarLine = Color3.fromRGB(55, 55, 60),
	Tab = Color3.fromRGB(100, 100, 105),

	Element = Color3.fromRGB(90, 90, 95),
	ElementBorder = Color3.fromRGB(45, 45, 50),
	InElementBorder = Color3.fromRGB(70, 70, 75),
	ElementTransparency = 0.88,

	ToggleSlider = Color3.fromRGB(110, 110, 115),
	ToggleToggled = Color3.fromRGB(12, 12, 14),

	SliderRail = Color3.fromRGB(100, 100, 105),

	DropdownFrame = Color3.fromRGB(140, 140, 145),
	DropdownHolder = Color3.fromRGB(28, 28, 32),
	DropdownBorder = Color3.fromRGB(45, 45, 50),
	DropdownOption = Color3.fromRGB(100, 100, 105),

	Keybind = Color3.fromRGB(100, 100, 105),

	Input = Color3.fromRGB(140, 140, 145),
	InputFocused = Color3.fromRGB(18, 18, 22),
	InputIndicator = Color3.fromRGB(130, 130, 135),

	Dialog = Color3.fromRGB(32, 32, 36),
	DialogHolder = Color3.fromRGB(24, 24, 28),
	DialogHolderLine = Color3.fromRGB(20, 20, 24),
	DialogButton = Color3.fromRGB(38, 38, 42),
	DialogButtonBorder = Color3.fromRGB(65, 65, 70),
	DialogBorder = Color3.fromRGB(55, 55, 60),
	DialogInput = Color3.fromRGB(42, 42, 46),
	DialogInputLine = Color3.fromRGB(140, 140, 145),
